        ...
        <div class="container">
            <div class="columns is-align-items-center">
                <div class="column is-3-widescreen has-text-centered">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/rodape-numem.png" alt="<?php bloginfo('name'); ?>" class="mr-3 mb-4"/>
            ...
            <div class="columns is-align-items-center">
                <div class="column creditos">
                    <!-- Wordpress -->
                    <a href="http://br.wordpress.org/" target="_blank" rel="noopener" data-tooltip="Desenvolvido com Wordpress">
                    ...
                    &mdash;
                    <!-- Git -->
                    <a href="https://github.com/IFRS/memoria-theme/" target="_blank" rel="noopener" data-tooltip="C&oacute;digo-fonte deste tema sob a licen&ccedil;a GPLv3">
                    ...
                    &mdash;
                    <!-- Creative Commons -->
                    <a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/4.0/" target="_blank" rel="noopener" data-tooltip="M&iacute;dia licenciada sob a Licen&ccedil;a Creative Commons Atribui&ccedil;&atilde;o-N&atilde;oComercial-CompartilhaIgual 4.0 Internacional">
